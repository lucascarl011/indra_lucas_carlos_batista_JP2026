...
import br.com.indra.lucas_carlos_batista_cp2026.mappers.EstoqueMapper;
...
public class EstoqueService {
        ...
        public EstoqueResponse getEstoque(Long produtoId) {
            Estoque estoque = estoqueRepository.findByProdutoId(produtoId)
                    .orElseGet(() -> criarEstoqueInicial(produtoId));
            return estoqueMapper.toResponse(estoque);
        }

        public EstoqueResponse adicionar(Long produtoId, Integer quantidade, String motivo) {
            Estoque estoque = estoqueRepository.findByProdutoId(produtoId)
                    .orElseGet(() -> criarEstoqueInicial(produtoId));
        ...
        public EstoqueResponse remover(Long produtoId, Integer quantidade, String motivo) {
            Estoque estoque = estoqueRepository.findByProdutoId(produtoId)
                    .orElseGet(() -> criarEstoqueInicial(produtoId));
        ...
        public EstoqueResponse ajustar(Long produtoId, Integer novaQuantidade, String motivo) {
            Estoque estoque = estoqueRepository.findByProdutoId(produtoId)
                    .orElseGet(() -> criarEstoqueInicial(produtoId));
        ...
        public EstoqueResponse devolver(Long produtoId, Integer quantidade, String motivo) {
            Estoque estoque = estoqueRepository.findByProdutoId(produtoId)
                    .orElseGet(() -> criarEstoqueInicial(produtoId));
        ...
        public List<InventarioTransacaoResponse> getHistorico(Long produtoId) {
            return transacaoRepository.findByProdutoId(produtoId)
                    .stream()
                    .map(estoqueMapper::toTransacaoResponse)
                    .toList();
        }
